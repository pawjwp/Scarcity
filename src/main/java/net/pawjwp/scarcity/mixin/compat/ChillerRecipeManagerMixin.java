...
// Makes the Blast Chiller match recipes by fluid type only, ignoring NBT.
// Equivalent to using FluidHelper.fluidHashcodeNoTag (already used by Bottler/Crystallizer).
// Requires enable_thermal_patches to be enabled in config.
@Pseudo
@Mixin(targets = "cofh.thermal.core.util.managers.machine.ChillerRecipeManager", remap = false)
public class ChillerRecipeManagerMixin {
